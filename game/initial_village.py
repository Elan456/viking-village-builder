...
def add_initial_buildings(village):
    ...
    # Add a buildershut
    village.add_building(Building(village, origin_x + BldInfo.get_width("mine") + 1 + BldInfo.get_width("grainfield") + 1, origin_y + BldInfo.get_height("lumbermill") + 1, "buildershut"))